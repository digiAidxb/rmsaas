            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    ...
                    <nav class="-mx-3 flex flex-1 justify-end">
                        ...
                        <template v-else>
                            <Link
                                v-if="canTenantRegister"
                                :href="route('tenant.register')"
                                class="rounded-md px-4 py-2 text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 ring-1 ring-transparent transition focus:outline-none focus-visible:ring-[#FF2D20] font-medium shadow-lg"
                            >
                                🏪 Register as Restaurant Business
                            </Link>
                        </template>
                    </nav>
                </header>
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <Link
                            v-if="canTenantRegister"
                            :href="route('tenant.register')"
                            class="flex items-start gap-4 rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 text-white"
                        >
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-white/20 sm:size-16"
                            >
                                <svg
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed text-blue-100">
                                    Create your restaurant tenant account and unlock powerful 
                                    analytics, inventory management, and profitability optimization tools. 
                                    Get 30 days free trial with enterprise-level features.
                                </p>
                            </div>

                            <svg
                                class="size-6 shrink-0 self-center stroke-white"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
